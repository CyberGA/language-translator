...
# arrow
translate_image = PhotoImage(file = "arrow.png")
img_label = Label(root, image = translate_image, width = 150)
...
label2 = Label(root, text="SELECT LANGUAGE", font="segoe 30 bold",
               bg="white", width=18, bd=5, relief=GROOVE)
...
# translate button
translate_button = Button(root, text="Translate", font="Roboto 15 bold",
